...
の2軸で発信を進めることで、スタッフのフォロワーからの流入も見込める。 
...
Pinterestで競合に似たデザインをリサーチし、独自の投稿デザインを完成させる。 
...
● 再生数が今までの再生数（2,000再生）を超えるまでは消し続ける 
